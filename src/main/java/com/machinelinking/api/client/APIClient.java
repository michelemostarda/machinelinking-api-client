...
/**
 * The official client for the <a href="http://machinelininking.com/">MachineLinking API</i>.
 *
...
public class APIClient {
    ...
    public GuessedLanguageResponse guessLanguage(String textToAnalyze, Map<String,Object> properties)
    ...
    public GuessedLanguageResponse guessLanguage(String textToAnalyze) throws IOException, APIClientException {
        return guessLanguage(textToAnalyze, new HashMap<String, Object>());
    }

    public AnnotationResponse annotate(String textToAnalyze, Map<String,Object> properties)
    throws IOException, APIClientException {
        properties.put(ParamsValidator.text, URLEncoder.encode(textToAnalyze, "UTF8"));
    ...
    public AnnotationResponse annotate(String textToAnalyze)
    throws IOException, APIClientException {
        return annotate(textToAnalyze, new HashMap<String, Object>());
    }

    public CompareResponse compare(
            ComparisonMethod compareMethod, String text1, String text2, Map<String,Object> properties
    ) throws IOException, APIClientException {
    ...
    throws IOException, APIClientException {
        return compare(compareMethod, text1, text2, new HashMap<String, Object>());
    }

    public SummaryResponse summarize(
            CompressionMethod compressionMethod, float compressionRatio, String text, Map<String,Object> properties
    ) throws IOException, APIClientException {
    ...
    throws IOException, APIClientException {
        return summarize(compressionMethod, compressionRatio, text, new HashMap<String, Object>());
    }
